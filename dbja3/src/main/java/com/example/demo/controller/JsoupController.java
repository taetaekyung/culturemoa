    ...
    public void newEvent() {
        ...
        for (int p = 1; p <= 12; p++) {
            ...
            try {
                ...
                Elements list = doc.getElementsByClass("title title-block"); // url주소의 book_tit 가져와
                for (Element e : list) {
        ...
        for (int i = 0; i < flist.size(); i++) {
            ...
            try {
                ...
                FileOutputStream fos = new FileOutputStream("src/main/resources/static/images/" + eventFname);
